  ...
  return (
    <div className="app-shell flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden w-full">
        {/* Left Sidebar */}
        <aside className="w-6 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col justify-between flex-shrink-0 z-40 py-4 px-0">
          <nav className="flex flex-col gap-1.5 w-full">
            <Link
              to="/home"
              className={`nav-item flex items-center justify-center px-0.5 py-2.5 rounded-lg transition-all ${
                isNavActive("/home")
